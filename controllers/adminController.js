...
const adminController = {
  createRestaurant: async (request, response) => {
    try {
      ...
      const { name, description, cuisine, location, openingHours, priceRange } =
        request.body;
      ...
      if (restaurantExists) {
        return response
          .status(400)
          .json({ message: "Restaurant alrady exist" });
      }
      ...
      return response
        .status(200)
        .json({ message: "Restaurant created successfuly", result });
    } catch (e) {
  ...
  updateRestaurants: async (request, response) => {
    try {
      ...
      return response
        .status(200)
        .json({ message: "update company endpoint", result: updateRestaurant });
    } catch (e) {
      return response.status(500).json({ message: e.message });
    }
  },
  ...
  updateOrderStatus: async (request, response) => {
    try {
      ...
      return response
        .status(200)
        .json({ message: "Order status updated successfully", result: order });
    } catch (e) {
      return response.status(500).json({ message: e.message });
    }
  },
  ...
  getAllReviews: async (request, response) => {
    try {
      ...
      return response
        .status(200)
        .json({ message: "Reviews fetched successfuly", result: reviews });
    } catch (e) {
      return response.status(500).json({ message: e.message });
    }
  },
  ...
  deleteReview: async (request, response) => {
    try {
      ...
      return response
        .status(200)
        .json({ message: "delete review successfuly", result: review });
    } catch (e) {
      return response.status(500).json({ message: e.message });
    }
  },
